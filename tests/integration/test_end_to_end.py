...
from customer_snapshot.utils.validators import safe_file_write, validate_file_path
from tests.fixtures import COMPLEX_VTT_CONTENT
...
class TestPerformanceIntegration:
    ...
    def test_memory_usage_integration(self, temp_dir):
        ...
        for i in range(100):
            ...
            content_parts.append(
                "Speaker: Long content repeated " * 50 + f" number {i}\n\n"
            )
