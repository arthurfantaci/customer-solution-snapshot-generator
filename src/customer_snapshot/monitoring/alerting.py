    ...
    def send_notification(
        ...
        for recipient in recipients:
            try:
                ...
                msg["To"] = recipient
                msg["Subject"] = (
                    f"[{alert.level}] Customer Snapshot Alert: {alert.name}"
                )
...
class SlackNotifier:
    ...
    def send_notification(
        self, alert: Alert, recipients: Optional[list[str]] = None
    ) -> list[AlertNotification]:
    ...
    def _initialize_notifiers(self):
        ...
        for config in self.notification_configs:
            ...
            try:
                ...
                logger.error(
                    f"Failed to initialize {config.channel.value} notifier: {e}"
                )
