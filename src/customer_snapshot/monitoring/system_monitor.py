                ...
                def do_GET(self):
                    if self.path == '/metrics':
                        try:
                            ...
                            prometheus_output = self.server.exporter.format_metrics(metrics)
...
class SystemMonitor:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "prometheus_running": self.prometheus_exporter.running if self.prometheus_exporter else False
        }
